...
builder.Services.AddScoped<IGenericRepository<StopRecords, int>, GenericRepository<StopRecords, int>>();
builder.Services.AddScoped<IGenericRepository<Tracking, int>, GenericRepository<Tracking, int>>();
