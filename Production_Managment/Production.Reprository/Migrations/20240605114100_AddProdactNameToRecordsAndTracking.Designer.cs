...
namespace Production.Reprository.Migrations
{
    ...
    [Migration("20240605114100_AddProdactNameToRecordsAndTracking")]
    partial class AddProdactNameToRecordsAndTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductStopRecords", b =>
                {
                    ...
                    b.HasKey("ProductsId", "StopRecordsId");

                    b.HasIndex("StopRecordsId");

                    b.ToTable("ProductStopRecords");
                });

            modelBuilder.Entity("ProductTracking", b =>
                {
                    b.Property<int>("ProductsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProductsId", "TrackingsId");

                    b.HasIndex("TrackingsId");

                    b.ToTable("ProductTracking");
                });
            ...
            modelBuilder.Entity("ProductStopRecords", b =>
                {
                    b.HasOne("Production.Core.Entities.Product", null)
                        .WithMany()
